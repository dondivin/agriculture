...
$search1 = mysqli_query($conn,"select * from rapport where province='".$sanitizedProvince."'");
...
$count1 = 1;
   ...
   $count1++;
               ...
               transform: translate(-50%);
               color: #00000094;
           ">Aucune donnée de cette  Province de '.$sanitizedProvince.'</h1>';
