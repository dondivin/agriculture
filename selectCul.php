...
$sanitizedProvince = mysqli_escape_string($conn,$prov);
$sanitizedCulture = mysqli_escape_string($conn,$culture);


$search1 = mysqli_query($conn,"select * from rapport where province='".$sanitizedProvince."' AND type_culture='".$sanitizedCulture."'");
...
}else if(mysqli_num_rows($search1)>0){
...
$count1 = 1;
   ...
   $count1++;
    ...
    transform: translate(-50%);
    color: #00000094;
">Aucune donnée de cette culture dans le province de '.$sanitizedProvince.'</h1>';
